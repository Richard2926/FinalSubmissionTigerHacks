...
import 'package:tigerhacks/components/food_card.dart';
import 'package:tigerhacks/components/grid_product.dart';
import 'package:tigerhacks/components/grocery_item.dart';
import 'package:tigerhacks/components/other_item.dart';
...
class _ExploreState extends State<Explore> {
  ...
  Color vegColor = Colors.transparent;
  bool reverse = false;
  List reversedList = [];
  List properList = [];
              ...
              if (snapshot.connectionState == ConnectionState.done) {
                ...
                for (QueryDocumentSnapshot i in data.docs) {
                  ...
                  if (doc['foodURL'] != null) {
                    ...
                    if (doc['veg'] != null) {
                      if (doc['veg']) vegStuff.add(doc);
                    }

                  }
                }

                vegStuff = List.from(vegStuff.reversed);
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FilterChip(
                                  ...
                                  backgroundColor: veg ? vegColor : Colors.transparent,
                                  shape: StadiumBorder(side: BorderSide()),
                                  onSelected: (bool value) {
                                    this.setState(() {
                                      vegColor = Colors.pinkAccent.withOpacity(0.3);
                                      veg = !veg;
                                    });
                                  },
                                ),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: ListView.separated(
                                            ...
                                            scrollDirection: Axis.vertical,
                                            itemCount: 20,
                                            itemBuilder: (_, i) => Container(height: 100, child: OtherItem(item: vegStuff[i])),
                                            separatorBuilder: (_, __) => SizedBox(height: 10),
                                          ),
                                        )
                                      ],
